...
class RegisterLotterAddres extends StatefulWidget {
  const RegisterLotterAddres({Key? key}) : super(key: key);

  @override
  State<RegisterLotterAddres> createState() => _RegisterLotterAddresState();
}

const kGoogleApiKey = Api.api_key;
final homeScaffoldKey = GlobalKey<ScaffoldState>();

class _RegisterLotterAddresState extends State<RegisterLotterAddres> {
