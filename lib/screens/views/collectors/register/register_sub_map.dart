...
class RegisterSubCollectionMap extends StatefulWidget {
  const RegisterSubCollectionMap({Key? key}) : super(key: key);

  @override
  State<RegisterSubCollectionMap> createState() =>
      _RegisterSubCollectionMapState();
}

const kGoogleApiKey = Api.api_key;
final homeScaffoldKey = GlobalKey<ScaffoldState>();

class _RegisterSubCollectionMapState extends State<RegisterSubCollectionMap> {
