...
class SubCollectorFileUpload extends StatefulWidget {
  const SubCollectorFileUpload({Key? key}) : super(key: key);

  @override
  State<SubCollectorFileUpload> createState() => _SubCollectorFileUploadState();
}

class _SubCollectorFileUploadState extends State<SubCollectorFileUpload> {
  final _globalKey = GlobalKey<FormState>();
  final _mainCollectorController = Get.find<MainCollectorController>();
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              if (_mainCollectorController.imageFile != null) {
                                _mainCollectorController.registerSubCollector(
